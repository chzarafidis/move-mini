...
> Άνοιγμα αυτής της σελίδας στο [https://chzarafidis.github.io/move-mini/](https://chzarafidis.github.io/move-mini/)
...
* αναζήτηση για **https://github.com/chzarafidis/move-mini** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/chzarafidis/move-mini/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/chzarafidis/move-mini** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/chzarafidis/move-mini/raw/master/.github/makecode/blocks.png)
